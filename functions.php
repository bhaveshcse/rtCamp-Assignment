...
function _s_scripts() {
	...
	wp_enqueue_style( 'custom', get_template_directory_uri() . '/lib/css/bootstrap.css', array(), '1.0.0', 'all');	
	
	wp_enqueue_style( 'custom2', get_template_directory_uri() . '/lib/css/custom.css', array(), '1.0.0', 'all');
	...
	wp_enqueue_script( '_s-js', get_template_directory_uri() . '/lib/js/bootstrap.js', array(), '20151215', true );
